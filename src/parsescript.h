...
typedef enum PARSE_ERROR {
    ...
    NON_BYTEALIGNED_FUNCTION = 17,

    // metadata parsing errors
    MISPLACED_METADATA_BLOCK = 18,
    UNKNOWN_METADATA_ATTRIBUTE = 19,
    MALFORMED_METADATA_ATTRIBUTE = 20,
    DUPLICATE_METADATA_ATTRIBUTE = 21,

    // function call parsing errors
    UNKNOWN_FUNCTION_NAME = 22,
    ARG_VALUE_PARSE_ERROR = 23,
    MISSING_ARG = 24,
    LEFTOVER_ARG = 25,
...
detailed_parse_error *err(swexp_list_node *location,
